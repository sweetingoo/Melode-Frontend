                ...
                for (const line of lines) {
                  ...
                  if (line.startsWith("event:")) {
                    ...
                    if (currentEvent.data !== null || (currentEvent.type && currentEvent.type !== "message")) {
                      ...
                      if (currentEvent.type && (currentEvent.type.startsWith("message:") || currentEvent.type.startsWith("notification:") || currentEvent.type.startsWith("broadcast:") || currentEvent.type === "patient_sms_received")) {
