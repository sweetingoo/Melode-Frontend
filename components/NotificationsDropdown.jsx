...
const NotificationsDropdown = () => {
  ...
  const handleNotificationClick = (notification) => {
    ...
    } else if (notification.category === "document" && (notification.metadata?.document_slug || notification.metadata?.document_id)) {
      // Fallback: route to document preview if category is document and we have document_slug or document_id
